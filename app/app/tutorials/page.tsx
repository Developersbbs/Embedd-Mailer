...
export default function TutorialsPage() {
  ...
  async function submitForm(event) {
    ...
    const response = await fetch('https://embedd.sbbs.cloud/api/forms/{PROJECT_ID}/submit', {
      method: 'POST',
      headers: {
...
<form onsubmit="submitForm(event)">
  ...
  try {
    const res = await fetch('https://embedd.sbbs.cloud/api/forms/{PROJECT_ID}/submit', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'x-api-key': 'YOUR_API_KEY'
    ...
    console.error(err);
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <pre className="bg-muted p-4 rounded-md overflow-x-auto text-sm">
                                    {`curl -X POST https://embedd.sbbs.cloud/api/forms/{PROJECT_ID}/submit \\
